export const packageTypes = [
  {
    ...
    description:
      "A Rigid Intermediate Bulk Container (RIBC) that is attached to a pallet or has the pallet integrated into the RIBC. The container is used for the transport and storage of fluids and other bulk materials. The construction of the IBC container and the materials used are chosen depending on the application.  There are various types available in the market place.\nFoldable (collapsible) IBC Container,\nPlastic composite IBC Container,\nWire Cage IBC Container,\nSteel IBC Container, and\nStainless steel IBC Container.",
  },
  {
    code: "AE",
    name: "Aerosol",
  ...
  },
  {
    ...
    name: "Ampoule",
    description:
      "A relatively small container made from glass or plastic tubing, the end of which is drawn into a stem and closed by fusion after filling. The bottom may be flat, convex, or drawn out. An ampule is opened by breaking the stem.",
  },
  {
    code: "BA",
    name: "Barrel",
  ...
  },
  {
    ...
    name: "Bottle",
    description:
      "A container having a round neck of relatively smaller diameter than the body, as compared with a jar, and an opening capable of holding a closure for retention of the contents. The cross section of the bottle may be round, oval, square, oblong, or a combination of these. Bottles generally are made of glass or plastics but can also be earthenware or metal. Bottle may be disposable, recyclable, returnable, or reusable.",
  },
  {
    code: "BPG",
    name: "Blister pack",
  ...
  },
  {
    ...
    name: "Chub",
    description:
      "A chub or a chub pack is a type of container formed by a tube of flexible, non-edible packaging material. The cylindrical package has the appearance of a sausage with the ends sealed by metal crimps or clips, e.g. for sausages (artificial intestine).",
  },
  {
    code: "CM",
    name: "Card",
  ...
  },
  {
    ...
    name: "Clam Shell",
    description:
      "A one-piece container consisting of two halves joined by a hinge area which allows the structure to come together to close. Clamshells get their name from their appearance to the shell of a clam, which it resembles both in form and function.",
  },
  {
    code: "CNG",
    //    name: "Can/Tin",
  ...
  },
  {
    ...
    name: "Cartridge",
    description:
      "A container holding a item or substance, designed for insertion into a mechanism. Examples: Ink. Beverage Syrup.",
  },
  {
    code: "CR",
    name: "Crate",
  ...
  },
  {
    ...
    name: "Carton",
    description:
      "A non-specific term for an open or re-closable container used mostly for perishable foods (e.g. eggs, or fruit).",
  },
  {
    code: "CU",
    name: "Cup/Tub/Bowl",
    description:
      "A flat-bottomed container that has a base of any shape and which may or not be closed with a lid. Usually made of paper, plastic or other materials these containers are typically used to contain mostly (but not exclusively) foods such as ice cream, margarine, yogurt, sour cream, confections, etc.",
  },
  {
    code: "CY",
    name: "Cylinder",
  ...
  },
  {
    code: "NE",
    name: "Not packed",
    description: "The item is provided without packaging.",
  },
  {
    code: "NT",
    name: "Net",
  ...
  },
  {
    ...
    name: "Pot",
    description:
      "A flat-bottomed container that has a base of any shape and which may or not be closed with a lid. Pots are usually made of cardboard, plastic, ceramic, metal or other materials and may be used for a wide array of products such as cosmetics, food/liquids, dairy products, plants.",
  },
  {
    code: "PU",
    name: "Tray",
  ...
  },
  {
    ...
    description:
      "Packaging of the product (or products) is currently not on the list. Use this code when no suitable options are available and only while a Change Request is approved for the proper packaging type.",
  },
  {
    code: "PX",
    name: "Pallet",
    description: "A platform used to hold or transport unit loads.",
  },
  {
    code: "RK",
    name: "Rack",
    description:
      "A non specific term identifying a framework or stand for carrying, holding, or storing items. Commonly on wheels and primarily used in the logistical functions to deliver items such as hanging garments, or items on shelves such as dairy products and bakery items and flowers.",
  },
  {
    code: "RL",
    name: "Reel",
    description:
      "A spool on which thread, wire, film, etc, is wound. Any device on which a material may be wound. Usually has flanged ends and is used for shipping or processing purposes.",
  },
  {
    code: "RO",
    name: "Roll",
  ...
  },
  {
    ...
    name: "Shrinkwrapped",
    description:
      "In packaging, a plastic film around an item or group of items which is heated causing the film to shrink, securing the unit integrity. The use of shrunken film to tightly wrap a package or a unit load in order to bind, protect and immobilize it for further handling or shipping.",
  },
  {
    code: "SY",
    name: "Sleeve",
  ...
  },
  {
    ...
    name: "Tube",
    description:
      "A cylindrical container sealed on one end that could be closed with a cap or dispenser on the other end.",
  },
  {
    code: "WIRE",
    name: "Wire",
    description:
      "A packaging made of a non-specific material in the form of very flexible thread or slender rod.",
  },
  {
    code: "WRP",
    name: "Wrapper",
    description:
      "The process of enclosing all or part of an item with layer(s) of flexible wrapping material (e.g., for an individually packed ice cream). Includes gas-tight packs (e.g. for sausages). Does not include items which are shrink-wrapped or vacuum-packed.",
  },
  {
    code: "X11",
    name: "Banded package",
...
export type PackageTypeCode = (typeof packageTypes)[number]["code"];
