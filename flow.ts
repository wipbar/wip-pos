export const draculaFlow = [
  ...
  "This shit ain't nothing to me, man",
  "I need my percs! I need my percs! One perc is never enough (Yo!)",
  ...
  "This shit ain't nothing to me man! I'll fucking kill you!",
...
export const tranculaFlow = [
  ...
  "doomin' the way I mick on that gord",
  "Call me a snail the way I blaze this trail",
  "I got that horse piss in my veins and the horse piss in my brain",
  "I pick up when the onion ring",
  "MY TUMMY HURTS",
  "AAHHHHH",
  "I got so much swag that even pitbull calls me for hair advice",
  "My money short my pockets fake",
  "I'm broke like Struensee",
  "Call my call wheezer the way I wanna fuck Jimmy's mom",
  "Smoked that shit that made Carl wheezer",
  "The slurs I use were minted in ancient mesopotamia and they haven't used since ea-nasir sold me that shit ass copper",
  "Jeg kan besværgelser du kun kan læse i Vagtårnet",
